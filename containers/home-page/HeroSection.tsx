...
function HeroSection() {
  return (
    <section className="relative my-5 container mx-auto md:rounded-xl ps-4 md:ps-5 lg:ps-10 w-full h-[400px] lg:h-[500px] bg-cover bg-no-repeat bg-[url('../assets/images/hero-section-mobile.jpg')] lg:bg-[url('../assets/images/hero-section-desktop.jpg')]">
